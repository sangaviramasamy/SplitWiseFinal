...
//        }
    ...
    public Response addUserGroup(long groupId , long userId , long createdBy){
        String message;
    ...
    public Response removeUserGroup(long groupId , long userId , long updatedBy) {
        String message;
        UserGroupMapping userGroup = userGroupRepository.findByGroupIdAndUserId(groupId , userId);
        if(Objects.isNull(userGroup)){
    ...
    public Response updateGroup(long userId , GroupVo groupVo) {
        ...
        if(Objects.isNull(group)){
            response.setStatus("Group Not Found");
            return response;
        }
        ...
        for (UserVo userVo : groupVo.getMemberPresent()){
            ...
            if(memberCheck.containsKey(tempUserId)){
                ...
                {
                    response.setStatus("UserId : "+ tempUserId + " , Not Found");
                    return response;
                }
            }
        }
